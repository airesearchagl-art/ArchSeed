...
def build_prompt(description: str, config: dict[str, Any]) -> str:
    ...
    return "\n".join(
        [
            ...
            '  {"schemaVersion":"archseed.v0.1","units":"mm","project":{...},',
            '   "building":{"footprint":{"width":...,"depth":...},',
            '   "levels":[{"name":"...","height":...}],',
            '   "openings":[...]}}',
            "- In footprint, use keys width and depth. Do not use width_mm,",
            "  length_mm, depth_mm, shape, or other footprint keys.",
            "- In levels, use keys name and height. Do not use height_mm.",
            "- Put openings in building.openings, not inside level objects.",
